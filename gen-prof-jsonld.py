...
CONTEXT = {
    ...
    "rightsHolder": {"@id": "dcterms:rightsHolder"},
    "rights": {"@id": "dcterms:rights"},
    "resource": {
        "@id": "prof:hasResource"
        # '@container': "@id"
    },
    "representationTechnique": {"@id": "adms:representationTechnique", "@type": "@id"},
    "format": {"@id": "dcterms:format", "@type": "@id"},
    "hasArtifact": {"@id": "prof:hasArtifact", "@type": "@id"},
    "hasRole": {"@id": "prof:hasRole", "@type": "@id"},
    "orcid": {"@id": "https://orcid.org/", "@type": "@id"},
}
